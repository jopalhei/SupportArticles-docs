...
## Get HTTP response codes by issuing API Calls

To make API calls to the application and get details about the response, you can choose from many other command-line and GUI tools. These tools include the following.
...
Once you get the response code, you should try to better understand the behavior that leads your application to respond with such a code. 

For more information about the HTTP status codes and the reason on why you're getting them, see the following content.
